...
-- адресует по строке комбы, без разбора владельца: если набор рига снимает
-- конфликтные комбы перед своими биндами, он снёс бы и контрактный, загрузись
-- контракт раньше. Идя последним и снимая комбу перед своей, он выигрывает
-- всегда.
--
-- То же на свитче: набор нового рига может занять контрактную комбу, поэтому
-- dotprofile переприменяет контракт после загрузки рига.
