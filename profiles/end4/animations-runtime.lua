-- Анимации рига end4 для применения в живую lua-сессию (hyprctl eval / dofile).
-- Standalone-извлечение из hyprland/general.lua (там анимации перемешаны с
-- input/misc — dofile целого перевыполнил бы лишнее). При хот-свитче в end4.
