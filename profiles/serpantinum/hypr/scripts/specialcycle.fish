...
# serpantinum's contract subset (KEYBINDS.md §2.3): scratchpad + the four app
# specials. No sysmon entry here — that combo is not part of what this rig
# binds, unlike caelestia's cycle (profiles/caelestia/hypr/scripts/specialcycle.fish).
set specials special music communication todo messanger
